...
public class JumboProductsProcessor {
	...
	public void  procesarProductosSinRespuesta(String categoria) {
		...
		try {
			...
			//result.getErrores().add("Falló al procesar los productos Jumbo de la categoria <<"+categoria+">>. Error "+e.getMessage());
			LOGGER.error("Falló al procesar los productos Jumbo de la categoria <<"+categoria+">>. Error "+e.getMessage());
		}
